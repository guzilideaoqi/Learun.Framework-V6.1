...
namespace Learun.Application.TwoDevelopment.Hyg_RobotModule
{
    ...
    /// 描 述：拼多多订单列表
    /// </summary>
    public class order_pddBLL : order_pddIBLL
    {
        private order_pddService order_pddService = new order_pddService();
        ...
        public IEnumerable<order_pddEntity> GetList( string queryJson )
        {
            try
            {
                return order_pddService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<order_pddEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return order_pddService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public order_pddEntity GetEntity(string keyValue)
        {
            try
            {
                return order_pddService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                order_pddService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, order_pddEntity entity)
        {
            try
            {
                order_pddService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
