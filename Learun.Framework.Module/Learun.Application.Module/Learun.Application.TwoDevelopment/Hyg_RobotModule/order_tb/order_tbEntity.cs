...

{
    ...
    public class order_tbEntity 
    {
        ...
        /// </summary>
        /// <returns></returns>
        [Column("TK_ORDER_ROLE")]
        public int? tk_order_role { get; set; }
        /// <summary>
        /// 订单确认收货后且商家完成佣金支付的时间
        /// </summary>
        /// <returns></returns>
        [Column("TK_EARNING_TIME")]
        ...
        /// </summary>
        /// <returns></returns>
        [Column("TK_TOTAL_RATE")]
        public decimal? tk_total_rate { get; set; }
        /// <summary>
        /// 商品所属的根类目，即一级类目的名称
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [Column("ALIMAMA_RATE")]
        public decimal? alimama_rate { get; set; }
        /// <summary>
        /// 平台出资方，如天猫、淘宝、或聚划算等
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        [Column("PUB_SHARE_PRE_FEE")]
        public decimal? pub_share_pre_fee { get; set; }
        /// <summary>
        /// 买家拍下付款的金额（不包含运费金额）
        /// </summary>
        /// <returns></returns>
        [Column("ALIPAY_TOTAL_PRICE")]
        ...
        /// <returns></returns>
        [Column("SUBSIDY_FEE")]
        public decimal? subsidy_fee { get; set; }
        /// <summary>
        /// 技术服务费=结算金额*收入比率*技术服务费率。推广者赚取佣金后支付给阿里妈妈的技术服务费用
        /// </summary>
        /// <returns></returns>
        [Column("ALIMAMA_SHARE_FEE")]
        public decimal? alimama_share_fee { get; set; }
        /// <summary>
        /// 买家在淘宝后台显示的订单编号
        /// </summary>
        /// <returns></returns>
        [Column("TRADE_PARENT_ID")]
        ...
        /// </summary>
        /// <returns></returns>
        [Column("TOTAL_COMMISSION_FEE")]
        public decimal? total_commission_fee { get; set; }
        /// <summary>
        /// 	预估专项服务费：内容场景专项技术服务费，内容推广者在内容场景进行推广需要支付给阿里妈妈专项的技术服务费用。专项服务费＝付款金额＊专项服务费率。
        /// </summary>
        /// <returns></returns>
        [Column("TK_COMMISSION_PRE_FEE_FOR_MEDIA_PLATFORM")]
        public decimal? tk_commission_pre_fee_for_media_platform { get; set; }
        /// <summary>
        /// 结算专项服务费：内容场景专项技术服务费，内容推广者在内容场景进行推广需要支付给阿里妈妈专项的技术服务费用。专项服务费＝结算金额＊专项服务费率。
        /// </summary>
        /// <returns></returns>
        [Column("TK_COMMISSION_FEE_FOR_MEDIA_PLATFORM")]
        public decimal? tk_commission_fee_for_media_platform { get; set; }
        /// <summary>
        /// 专项服务费率：内容场景专项技术服务费率，内容推广者在内容场景进行推广需要按结算金额支付一定比例给阿里妈妈作为内容场景专项技术服务费，用于提供与内容平台实现产品技术对接等服务。
        /// </summary>
        /// <returns></returns>
        [Column("TK_COMMISSION_RATE_FOR_MEDIA_PLATFORM")]
        public decimal? tk_commission_rate_for_media_platform { get; set; }
        /// <summary>
        /// 会员运营id
        /// </summary>
        /// <returns></returns>
