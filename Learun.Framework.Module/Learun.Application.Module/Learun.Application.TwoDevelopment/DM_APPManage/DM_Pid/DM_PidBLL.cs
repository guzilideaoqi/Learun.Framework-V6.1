...
namespace Learun.Application.TwoDevelopment.DM_APPManage
{
    ...
    /// 描 述：pid管理
    /// </summary>
    public class DM_PidBLL : DM_PidIBLL
    {
        private DM_PidService dM_PidService = new DM_PidService();
        ...
        public IEnumerable<dm_pidEntity> GetList(string queryJson)
        {
            try
            {
                return dM_PidService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<dm_pidEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return dM_PidService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public dm_pidEntity GetEntity(int keyValue)
        {
            try
            {
                return dM_PidService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(int keyValue)
        {
            try
            {
                dM_PidService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(int keyValue, dm_pidEntity entity)
        {
            try
            {
                dM_PidService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
