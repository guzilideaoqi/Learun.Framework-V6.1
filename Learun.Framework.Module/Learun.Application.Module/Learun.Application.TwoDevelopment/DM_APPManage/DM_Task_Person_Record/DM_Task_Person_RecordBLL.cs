...
namespace Learun.Application.TwoDevelopment.DM_APPManage
{
    ...
    /// 描 述：任务进度记录
    /// </summary>
    public class DM_Task_Person_RecordBLL : DM_Task_Person_RecordIBLL
    {
        ...
        public IEnumerable<dm_task_person_recordEntity> GetList( string queryJson )
        {
            try
            {
                return dM_Task_Person_RecordService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<dm_task_person_recordEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return dM_Task_Person_RecordService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public dm_task_person_recordEntity GetEntity(int keyValue)
        {
            try
            {
                return dM_Task_Person_RecordService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(int keyValue)
        {
            try
            {
                dM_Task_Person_RecordService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(int keyValue, dm_task_person_recordEntity entity)
        {
            try
            {
                dM_Task_Person_RecordService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
