...
namespace Learun.Application.TwoDevelopment.DM_APPManage
{
    ...
    /// 描 述：文案管理
    /// </summary>
    public interface DM_ArticleIBLL
    {
        #region 获取数据
        ...
        /// <summary>
        /// <returns></returns>
        IEnumerable<dm_articleEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 获取实体数据
        /// <param name="keyValue">主键</param>
        /// <summary>
        /// <returns></returns>
        dm_articleEntity GetEntity(int keyValue);
        #endregion
        ...
        /// <summary>
        /// <returns></returns>
        void SaveEntity(int keyValue, dm_articleEntity entity);
        #endregion
