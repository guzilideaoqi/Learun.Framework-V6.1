...
namespace Learun.Application.TwoDevelopment.DM_APPManage
{
    ...
    /// 描 述：套餐模板
    /// </summary>
    public class DM_Alipay_TemplateBLL : DM_Alipay_TemplateIBLL
    {
        private DM_Alipay_TemplateService dM_Alipay_TemplateService = new DM_Alipay_TemplateService();
        ...
        public IEnumerable<dm_alipay_templateEntity> GetList(string queryJson)
        {
            try
            {
                return dM_Alipay_TemplateService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<dm_alipay_templateEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return dM_Alipay_TemplateService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public dm_alipay_templateEntity GetEntity(int keyValue)
        {
            try
            {
                return dM_Alipay_TemplateService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(int keyValue)
        {
            try
            {
                dM_Alipay_TemplateService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<dm_alipay_templateEntity> GetListByCache(string appid)
        {
            try
            {
                return dM_Alipay_TemplateService.GetListByCache(appid);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public dm_alipay_templateEntity GetEntityByCache(int templateID, string appid)
        {
            try
            {
                return dM_Alipay_TemplateService.GetEntityByCache(templateID, appid);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
