...
namespace Learun.Application.TwoDevelopment.DM_APPManage
{
    ...
    /// 描 述：合伙人申请
    /// </summary>
    public interface DM_APP_Partners_RecordIBLL
    {
        #region 获取数据
        ...
        /// <summary>
        /// <returns></returns>
        IEnumerable<dm_apply_partners_recordEntity> GetList( string queryJson );
        /// <summary>
        /// 获取列表分页数据
        ...
        /// <summary>
        /// <returns></returns>
        dm_apply_partners_recordEntity GetEntity(int keyValue);
        #endregion
