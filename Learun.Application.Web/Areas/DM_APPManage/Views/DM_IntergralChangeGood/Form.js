...
var bootstrap = function ($, learun) {
    ...
    acceptClick = function (callBack) {
        ...
        if (!!f) {
            ...
            $.ajaxFileUpload({
                url: "/DM_APPManage/DM_IntergralChangeGood/UploadFile?keyValue=" + keyValue,
                secureuri: false,
            ...
            $.lrSaveForm(top.$.rootUrl + '/DM_APPManage/DM_IntergralChangeGood/SaveForm?keyValue=' + keyValue, postData, function (res) {
                // 保存成功后才回调
                if (!!callBack) {
                    callBack();
                }
