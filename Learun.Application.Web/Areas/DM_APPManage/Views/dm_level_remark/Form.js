...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            ...
            if (!!selectedRow) {
                ...
                headimg = selectedRow.RemarkImage;
            }
    ...
    acceptClick = function (callBack) {
        ...
        if (!!f) {
            ...
            $.ajaxFileUpload({
                url: "/DM_APPManage/dm_level_remark/UploadFile?keyValue=" + keyValue,
                secureuri: false,
            ...
            $.lrSaveForm(top.$.rootUrl + '/DM_APPManage/dm_level_remark/SaveForm?keyValue=' + keyValue, postData, function (res) {
                // 保存成功后才回调
                if (!!callBack) {
                    callBack();
                }
