        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                learun.layerForm({
                    id: 'form',
                    title: '新增',
                    url: top.$.rootUrl + '/DM_APPManage/DM_AccountDetail/Form',
                    width: 700,
                    height: 400,
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑',
                        url: top.$.rootUrl + '/DM_APPManage/DM_AccountDetail/Form?keyValue=' + keyValue,
                        width: 700,
                        height: 400,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            learun.deleteForm(top.$.rootUrl + '/DM_APPManage/DM_AccountDetail/DeleteForm', { keyValue: keyValue}, function () {
                            });
                        }
                    });
                }
        ...
        initGird: function () {
            $('#girdtable').lrAuthorizeJfGrid({
                ...
                headData: [
                        ...
                        { label: '当前账户金额(增长之后的)', name: 'currentvalue', width: 200, align: "left" },
                        { label: '金额明细', name: 'stepvalue', width: 200, align: "left" },
