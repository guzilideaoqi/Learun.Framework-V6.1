...
namespace Learun.Application.Web.Areas.DM_APPManage.Controllers
{
    ...
    /// 描 述：模板对应模块
    /// </summary>
    public class dm_decoration_template_moduleController : MvcControllerBase
    {
        private dm_decoration_template_moduleIBLL dm_decoration_template_moduleIBLL = new dm_decoration_template_moduleBLL();
        ...
        {
            var data = dm_decoration_template_moduleIBLL.GetList(queryJson);
            return Success(data);
        }
        /// <summary>
        /// 获取列表分页数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dm_decoration_template_moduleIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
