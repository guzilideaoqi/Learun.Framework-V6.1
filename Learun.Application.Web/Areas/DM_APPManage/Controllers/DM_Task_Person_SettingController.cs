...
namespace Learun.Application.Web.Areas.DM_APPManage.Controllers
{
    ...
    /// 描 述：进度任务设置
    /// </summary>
    public class DM_Task_Person_SettingController : MvcControllerBase
    {
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dM_Task_Person_SettingIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dM_Task_Person_SettingIBLL.GetEntity(keyValue);
            return Success(data);
        }
        #endregion
        ...
        {
            dM_Task_Person_SettingIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
