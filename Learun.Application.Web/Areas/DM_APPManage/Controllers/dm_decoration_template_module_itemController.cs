...
namespace Learun.Application.Web.Areas.DM_APPManage.Controllers
{
    ...
    /// 描 述：模块对应功能
    /// </summary>
    public class dm_decoration_template_module_itemController : MvcControllerBase
    {
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dm_decoration_template_module_itemIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dm_decoration_template_module_itemIBLL.GetEntity(keyValue);
            return Success(data);
        }
        #endregion
        ...
        {
            dm_decoration_template_module_itemIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
