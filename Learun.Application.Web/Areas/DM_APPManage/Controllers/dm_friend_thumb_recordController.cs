...
namespace Learun.Application.Web.Areas.DM_APPManage.Controllers
{
    ...
    /// 描 述：点赞记录
    /// </summary>
    public class dm_friend_thumb_recordController : MvcControllerBase
    {
        ...
        {
            var data = dm_friend_thumb_recordIBLL.GetList(queryJson);
            return Success(data);
        }
        /// <summary>
        /// 获取列表分页数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dm_friend_thumb_recordIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dm_friend_thumb_recordIBLL.GetEntity(keyValue);
            return Success(data);
        }
        #endregion
        ...
        {
            dm_friend_thumb_recordIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
