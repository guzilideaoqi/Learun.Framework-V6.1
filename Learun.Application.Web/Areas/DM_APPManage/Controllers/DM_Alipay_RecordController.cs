...
namespace Learun.Application.Web.Areas.DM_APPManage.Controllers
{
    ...
    /// 描 述：开通代理记录
    /// </summary>
    public class DM_Alipay_RecordController : MvcControllerBase
    {
        ...
        {
            var data = dM_Alipay_RecordIBLL.GetList(queryJson);
            return Success(data);
        }
        /// <summary>
        /// 获取列表分页数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dM_Alipay_RecordIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dM_Alipay_RecordIBLL.GetEntity(keyValue);
            return Success(data);
        }
        #endregion
        ...
        {
            dM_Alipay_RecordIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
