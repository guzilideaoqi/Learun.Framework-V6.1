...
namespace OrderService.Common
{
    ...
    /// </summary>
    public sealed class MySqlHelperByH
    {
        #region 默认的数据库连接字符串，读取web.config
        //public static readonly string DBConnectionString = "server=cdb-4omwne6j.gz.tencentcdb.com;port=10026;user id=root;password=Hyg920511;database=dm_data;charset=utf8";
        public static readonly string DBConnectionString = "server=bj-cdb-q1vbq4aq.sql.tencentcdb.com;port=61217;user id=root;password=!@#123Hebeihanya;database=dm_data;charset=utf8";
        #endregion
